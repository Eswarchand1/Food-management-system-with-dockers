...
<body>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-maps-local-restaurant"></i> Order Food</a>
            </li>
                <li class="no-padding">
            ...
            <li class="bold"><a href="routers/logout.php" class="waves-effect waves-cyan"><i class="mdi-hardware-keyboard-tab"></i> Logout</a></li>			
        </ul>
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><div class="input-field col s12"><label>Value 0 for none</label>';
 ...
 <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © <?php echo date("Y"); ?> <a class="grey-text text-lighten-4" href="#" target="_blank">Students</a> All rights reserved.</span>
